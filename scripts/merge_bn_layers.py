...
import argparse
import sys
caffe_root = '/home/viveksuryamurthy/Vivek/code/caffe/caffe-segnet-cudnn5-v2/caffe-segnet-cudnn5/'  # Change this to the absolute directory to SegNet Caffe
...
if __name__ == '__main__':
    ...
    path = os.path.join(args.out_dir, "final_model.prototxt")
    with open(path, 'w') as m:
        m.write(text_format.MessageToString(msg_proto))

    # save weights
    print "Saving new weights..."
    network.save(os.path.join(args.out_dir, "final_weights.caffemodel"))
    print "Done!"
