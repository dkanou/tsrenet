...
#Compute batch norm parameters from the training set

caffe_root = '/home/viveksuryamurthy/Vivek/code/caffe/caffe-segnet-cudnn5-v2/caffe-segnet-cudnn5/' # Change this to the absolute directoy to SegNet Caffe
import sys
...
if __name__ == '__main__':
    ...
    train_ims = extract_dataset(testable_msg)
    ...
    test_net.save(os.path.join(args.out_dir, "final_seg.caffemodel"))
    print "done"
